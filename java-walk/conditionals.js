    ...
    /*here we are promting the user to enter a age
    then it will check that age with the series of if statements
    and if age matches to a certain group, it will print out the 
